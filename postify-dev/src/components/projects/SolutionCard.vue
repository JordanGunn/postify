<template>
  ...
  <div id="maincard" class="card text">
    ...
    <div id="cardbody" class="card-body">
      ...
      <p>Github link: <a href="https://github.com" class="link-primary"> {{ solGitLink }}</a></p>
    </div>
    <div id="cardfooter">
         ...
         <button type="button" class="btn btn-success votebutton">
           <svg
         ...
         <!-- <span class="votecount">Votes: 22</span> -->
         <span class="votecount">Votes: {{ solUpVote }}</span>
         </div>

         <div class="buttoncontainer">
         <button type="button" class="btn btn-danger votebutton">
           <svg
             xmlns="http://www.w3.org/2000/svg"
             width="16"
             height="16"
         ...
         <!-- <span class="votecount">Votes: 3</span> -->
         <span class="votecount">Votes: {{ solDownVote }}</span>
         </div>
       </div>
